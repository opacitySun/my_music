...
footer #playerCtrl > div .button.loop {
  background-image: url("images/pcrl/loop.png");
}
footer #playerCtrl > div .button.random {
  background-image: url("images/pcrl/random.png");
}
footer #playerCtrl > div .button.prev {
  background-image: url("images/pcrl/prev.png");
}
footer #playerCtrl > div .button.play {
  background-image: url("images/pcrl/play.png");
}
footer #playerCtrl > div .button.pause {
  background-image: url("images/pcrl/pause.png");
}
footer #playerCtrl > div .button.next {
  background-image: url("images/pcrl/next.png");
}
footer #playerCtrl > div .button.collect {
  background-image: url("images/pcrl/collect.png");
}
header .playing_info {
  width: 100%;
  overflow: hidden;
...
.panel.playlist .music_list li.selected .right .stateIcon {
  ...
  height: 50px;
  overflow: hidden;
  background: url("images/playing.png") 0 -15px no-repeat;
...
.panel.album .album_art {
  ...
  background: url("images/bg-song-disc.png") no-repeat;
